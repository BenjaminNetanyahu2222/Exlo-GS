...
{
public:
	TMulticastInlineDelegate<void(bool Accepted)> OnEulaResponse;                                    // 0x0360(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
