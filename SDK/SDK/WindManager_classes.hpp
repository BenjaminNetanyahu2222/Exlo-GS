...
public:
	...
	struct FBox                                   Max_level_bounds___used_to_isolate_the_level_from_the_vista; // 0x0558(0x001C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
