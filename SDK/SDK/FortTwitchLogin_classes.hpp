...
public:
	...
	TMulticastInlineDelegate<void(class FText NewTooltipText)> OnRequestToolTipChange;               // 0x02D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
