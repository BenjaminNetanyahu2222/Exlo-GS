...
public:
	...
	class AActor*                                 CallFunc_EffectContextGetInstigatorActor_ReturnValue; // 0x00E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AB_Perk_C_Constructor_BASE_C*           K2Node_DynamicCast_AsB_Perk_C_Constructor_BASE;    // 0x00E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_ExecuteGC_Overflow;                       // 0x0140(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
