...
bool UGA_Athena_FireworksMortar_RocketTrajectory_C::ShouldOnlyShowTrajectoryOnUse() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_FireworksMortar_RocketTrajectory_C", "ShouldOnlyShowTrajectoryOnUse");

	Params::GA_Athena_FireworksMortar_RocketTrajectory_C_ShouldOnlyShowTrajectoryOnUse Parms{};
