...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_SetScrollWidget;
...
public:
	...
	TDelegate<void(class UCommonButton* Button)>  K2Node_CreateDelegate_OutputDelegate_1;            // 0x0010(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class UCommonButton* Button)>  K2Node_CreateDelegate_OutputDelegate_2;            // 0x0020(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class UCommonButton* Button)>  K2Node_CreateDelegate_OutputDelegate_3;            // 0x0030(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class UCommonButton* Button)>  K2Node_CreateDelegate_OutputDelegate_4;            // 0x0040(0x0010)(ZeroConstructor, NoDestructor)
};
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_BindDelegates;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Reset_To_Show_Help;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Update_Colors;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_SetupTriangles;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Set_Up_Header_Colors;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Handle_Continue;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Handle_OptIn_Accept;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Handle_OptIn_Cancel;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Handle_Help_Button;
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_Handle_Cancel_Preview;
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonButton*                          K2Node_CustomEvent_Button_4;                       // 0x0008(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButton*                          K2Node_CustomEvent_Button_3;                       // 0x0010(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonButton*                          K2Node_CustomEvent_Button_2;                       // 0x0018(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCommonButton*                          K2Node_CustomEvent_Button_1;                       // 0x0040(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_ItemInspectAlterationModOptInScreen_C_ExecuteUbergraph_ItemInspectAlterationModOptInScreen;
