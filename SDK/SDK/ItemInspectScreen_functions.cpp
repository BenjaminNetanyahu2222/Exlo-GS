...
void UItemInspectScreen_C::HandleVaultItemsViewed(TArray<class UFortItem*>& Items)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ItemInspectScreen_C", "HandleVaultItemsViewed");

	Params::ItemInspectScreen_C_HandleVaultItemsViewed Parms{};
...
// const class FString&                    OriginalItemInstanceId                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
void UItemInspectScreen_C::HandleEvolutionComplete(bool bWasSuccessful, const class FString& OriginalItemInstanceId, TArray<struct FFortItemInstanceQuantityPair>& ResultingItems)
{
	static class UFunction* Func = nullptr;
	...
	Parms.OriginalItemInstanceId = std::move(OriginalItemInstanceId);
...
void UItemInspectScreen_C::CheckIfCelebrateFXIsComplete()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ItemInspectScreen_C", "CheckIfCelebrateFXIsComplete");
