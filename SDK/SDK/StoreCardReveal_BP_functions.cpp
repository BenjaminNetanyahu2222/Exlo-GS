...
void AStoreCardReveal_BP_C::IsCurrentCardChoicePack(bool* IsChoicePack)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("StoreCardReveal_BP_C", "IsCurrentCardChoicePack");

	Params::StoreCardReveal_BP_C_IsCurrentCardChoicePack Parms{};
...
void AStoreCardReveal_BP_C::SetRarityColor_CC(int32 ChoiceIndex_0, class UMaterialInstanceDynamic* MID_Choice_Sticker)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("StoreCardReveal_BP_C", "SetRarityColor_CC");

	Params::StoreCardReveal_BP_C_SetRarityColor_CC Parms{};
...
void AStoreCardReveal_BP_C::Handle_Input_Mode_Changed(ECommonInputType bNewInputType)
{
	static class UFunction* Func = nullptr;
...
void AStoreCardReveal_BP_C::ResetForTransition()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("StoreCardReveal_BP_C", "ResetForTransition");
