...
public:
	...
	TMulticastInlineDelegate<void(int32 Selected_Index, const struct FGameplayTag& Gameplay_Tag)> Selection_Changed; // 0x0288(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
