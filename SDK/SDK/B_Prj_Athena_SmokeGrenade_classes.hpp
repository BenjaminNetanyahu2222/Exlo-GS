...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_B_Prj_Athena_SmokeGrenade_C;        // 0x0758(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UParticleSystem*                        P_SmokeGrenadeExplosion;                           // 0x0760(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
