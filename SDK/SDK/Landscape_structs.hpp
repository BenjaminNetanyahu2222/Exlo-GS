...
public:
	...
	TArray<int8>                                  HeightmapBrushOrderIndices;                        // 0x0038(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int8>                                  WeightmapBrushOrderIndices;                        // 0x0048(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class ULandscapeLayerInfoObject*, bool>  WeightmapLayerAllocationBlend;                     // 0x0058(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
};
