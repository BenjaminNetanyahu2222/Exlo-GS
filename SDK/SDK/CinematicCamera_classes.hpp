...
{
public:
	struct FCameraFilmbackSettings                FilmbackSettings;                                  // 0x07E0(0x000C)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraLensSettings                    LensSettings;                                      // 0x07EC(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_804[0x4];                                      // 0x0804(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCameraFocusSettings                   FocusSettings;                                     // 0x0808(0x0058)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_86C[0xC];                                      // 0x086C(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
