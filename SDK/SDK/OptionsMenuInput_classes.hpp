...
public:
	...
	TMulticastInlineDelegate<void(int32 Number_in_List, bool Is_Primary_Button)> Input_Clicked;      // 0x0268(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(int32 Number_in_List, class UOptionsMenuInput_C* Widget)> UnbindClicked; // 0x0298(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
