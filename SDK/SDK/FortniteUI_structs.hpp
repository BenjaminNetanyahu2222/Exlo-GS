...
// 0x0088 (0x0090 - 0x0008)
struct FFortPlayerSurveyCMSDataConditionAthenaMatchStat final : public FFortPlayerSurveyCMSDataConditionBase
{
public:
	TArray<EFortPlayerSurveyCMSDataPlaylistCategory> pt;                                             // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<class FName>                             P;                                                 // 0x0018(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         I;                                                 // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class FString                                 S;                                                 // 0x0078(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortPlayerSurveyCMSDataAggregateOp           ag;                                                // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortPlayerSurveyCMSDataBinaryComparisonOp    O;                                                 // 0x0089(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8A[0x2];                                       // 0x008A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         T;                                                 // 0x008C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
DUMPER7_ASSERTS_FFortUIStateTriggerEvalContext;
