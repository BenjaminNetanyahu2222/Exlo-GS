...
public:
	...
	TMulticastInlineDelegate<void(bool Succeeded, TArray<struct FFortItemInstanceQuantityPair>& Rewards)> OnExpeditionCompleted; // 0x0320(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
