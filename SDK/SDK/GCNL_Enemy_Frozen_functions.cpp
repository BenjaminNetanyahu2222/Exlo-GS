...
void AGCNL_Enemy_Frozen_C::ExecuteUbergraph_GCNL_Enemy_Frozen(int32 EntryPoint)
{
	...
	Params::GCNL_Enemy_Frozen_C_ExecuteUbergraph_GCNL_Enemy_Frozen Parms{};
...
void AGCNL_Enemy_Frozen_C::OnRemoval(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static class UFunction* Func = nullptr;
	...
	Params::GCNL_Enemy_Frozen_C_OnRemoval Parms{};
...
void AGCNL_Enemy_Frozen_C::OnLoopingStart(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents)
{
	static class UFunction* Func = nullptr;
	...
	Params::GCNL_Enemy_Frozen_C_OnLoopingStart Parms{};
