...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Perk_H_FrozenCastle_FreezeOnHit_C; // 0x0A80(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UClass*                                 GE_Freeze;                                         // 0x0A88(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                  TC_FrozenCastle_Cooldown_Tag;                      // 0x0A90(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTag                           TC_Fire_NPC;                                       // 0x0AB0(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           TC_Lightning_NPC;                                  // 0x0AB8(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	float                                         FreezeDurationModifier;                            // 0x0AC0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         FreezeVulnerabilityModifier;                       // 0x0AC4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("GA_Perk_H_FrozenCastle_FreezeOnHit_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GA_Perk_H_FrozenCastle_FreezeOnHit_C")
	}
...
DUMPER7_ASSERTS_UGA_Perk_H_FrozenCastle_FreezeOnHit_C;
