...
{
public:
	uint8                                         Pad_0[0x690];                                      // 0x0000(0x0690)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
struct FAnimNode_SubInstance final : public FAnimNode_CustomProperty
{
public:
	struct FPoseLink                              InPose;                                            // 0x0058(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	TSubclassOf<class UAnimInstance>              InstanceClass;                                     // 0x0068(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                         Pad_690[0x150];                                    // 0x0690(0x0150)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
// ScriptStruct Engine.AutomatedTestFilter
// 0x0018 (0x0018 - 0x0000)
...
// ScriptStruct Engine.AutomatedTestGroup
// 0x0020 (0x0020 - 0x0000)
...
public:
	...
	uint8                                         bBakeVertexDataToMesh : 1;                         // 0x0089(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseVertexDataForBakingMaterial : 1;               // 0x0089(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseTextureBinning : 1;                            // 0x0089(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReuseMeshLightmapUVs : 1;                         // 0x008A(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMergeEquivalentMaterials : 1;                     // 0x008A(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseLandscapeCulling : 1;                          // 0x008A(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIncludeImposters : 1;                             // 0x008A(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAllowDistanceField : 1;                           // 0x008A(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
