...
void UMTXButton_C::HandleInputActionChanged(ECommonInputType bNewInputType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MTXButton_C", "HandleInputActionChanged");

	Params::MTXButton_C_HandleInputActionChanged Parms{};
